...
#
# @param architectures Specify the list of supported architectures as an Array. If ommited Aptly assumes the repository.
# @param comment Specifiy a comment to be set for the repository.
# @param component Specify which component to put the package in. This option will only works for aptly version >= 0.5.0.
# @param distribution Specify the default distribution to be used when publishing this repository.
#
define aptly::repo (
  Array $architectures = [],
